        ...
        <div class="row product-detail" data-aos="fade-up">
          <div class="col-md-6 mb-4">
            <div class="flex-gallery">
              <div class="flex-gallery">
  <div class="border" style="background-image: url(\''.$p['image1'].'\');"
></div>
  <div class="border" style="background-image: url(\''.$p['image2'].'\');"
></div>
</div>
          ...
          <div class="col-md-6">
            ...
            <p><strong>Description:</strong> '.htmlspecialchars($p['desc']).'</p>
            <form action="add-to-cart.php" method="post">
              ...
              <input type="hidden" name="product_desc" value="'.htmlspecialchars($p['desc']).'">
